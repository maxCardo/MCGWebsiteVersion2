...
mysqli_query($connect,"INSERT INTO user_Site (siteuser_first, siteuser_Last, siteuser_added, siteuser_dob)
VALUES ('$_POST[post_first]', '$_POST[post_last]', CURRENT_TIMESTAMP, '$_POST[post_dob]')";
